output "workspace_name" {
  description = "Name of the created PHI workspace"
  value       = data.coder_workspace.me.name
}

output "workspace_owner" {
  description = "Owner of the PHI workspace"
...
output "namespace" {
  description = "Kubernetes namespace where PHI workspace is deployed"
  value       = var.namespace
}

output "phi_enabled" {
  description = "PHI compliance mode status"
  value       = "enabled"
}
