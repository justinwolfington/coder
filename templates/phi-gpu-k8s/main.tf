...
module "cpu_resources" {
  source = "git::https://github.com/abridgeai/coder.git//modules/resources/cpu?ref=v1.15.0"
}
...
module "workspace_scripts" {
  source       = "git::https://github.com/abridgeai/coder.git//modules/utilities/workspace-scripts?ref=v1.15.0"
  start_count  = data.coder_workspace.me.start_count
  agent_id     = coder_agent.main.id
...
module "utd_bucket" {
  source                 = "git::https://github.com/abridgeai/coder.git//modules/utilities/gcs-bucket?ref=v1.15.0"
